...
//Name: Room.ma
//Last modified: Tue, Nov 13, 2018 12:34:36 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1422.4151524140436 549.47197823499437 507.16388943938102 ;
	setAttr ".r" -type "double3" -15.338352729601583 -69.000000000002672 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "EA767BD7-401E-FA94-75FB-F3B1919C2C0E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1626.6397718543208;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D21CF035-4534-64EA-0185-8BAF3570564B";
	setAttr -s 16 ".lnk";
	setAttr -s 12 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AD61C1D0-49A2-4151-6574-8EAACD05DDCE";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6F7A70A2-4340-2853-A54F-3A96555B7120";
createNode displayLayerManager -n "layerManager";
	rename -uid "150FA1C2-4859-4A94-75B3-1995909D43A1";
createNode displayLayer -n "defaultLayer";
	rename -uid "351DADFC-4D15-7FD3-B903-38BD8DF6E6B3";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D8279E35-4DF0-38AC-43D9-5C850A004136";
